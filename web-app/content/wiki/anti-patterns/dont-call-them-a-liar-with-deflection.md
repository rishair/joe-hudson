...
aliases: ["don't call them a liar with deflection", "deflecting a compliment is calling them a liar", "you're telling them they're a liar", "the polite-thank-you-while-still-thinking-they're-a-liar", "deflecting compliments is rude", "deflecting compliments costs them", "the deflection-as-disagreement anti-pattern", "deflection contradicts the giver", "saying thank you while disbelieving is still deflection", "the polite-deflection trap", "the polite-disbelief deflection", "the I'll-be-polite-but-disbelieve move", "no I'm not the pretty one move", "the you're-the-pretty-one deflection", "deflecting hurts the giver", "the compliment-giver felt rejection", "the giver stops giving compliments after deflection", "the deflection costs the relationship", "the unreceived compliment as rejection of the giver", "saying thank you is not enough you have to receive", "your boss gives you a compliment you don't let it in", "what do you think the chances your boss wants to give you another compliment", "the boss-stops-complimenting variant of deflection cost", "the workplace cost of compliment deflection", "deflection turns the boss into the not-seeing boss", "the deflection produces the not-seen-by-boss story", "the deflection generates its own evidence the boss doesn't see"]
tags: ["compliments", "anti-pattern", "approval", "humility", "deflection", "smallness", "self-deprecation", "workplace", "burnout-engine"]
sources: ["2024-08-12_STOP Chasing Approval — Here's How To Get Free", "2025-07-09_If You Can't Accept Compliments, Watch This (Coaching Session With Joe Hudson)", "2025-07-24_You're Deflecting What You Want Most (Coaching With Joe Hudson)", "2025-08-07_Why Your Boss Never Sees You (Even When They Try) - Follow-along Coaching Session", "2025-11-18_You're Pushing Away What You Most Want"]
---
...
## Three Forms of the Same Anti-Pattern

The deflection arrives in three forms that all do the same structural work. Naming them as separate forms is useful diagnostically: a client may eliminate one while still running the others without noticing.

**Form 1: verbal denial of the fact.** "Oh no, the dress isn't that nice." "No, I'm not really pretty." "That wasn't anything special." The compliment said X is true; the response says X is not true. The disagreement is explicit. This is the form that gets noticed and addressed first.

**Form 2: verbal acceptance with internal denial.** "Uh-huh, yeah" or "thanks" while the mind silently completes the deflection — "oh, they don't really know me." "If they knew the real me, they wouldn't say that." This is the polite-thank-you-with-internal-disbelief failure mode. The verbal surface has been smoothed, but the structural deflection continues. The compliment still does not land. The giver still feels the absence.

**Form 3: attributing motive to the giver.** "Oh, that person's just trying to sell me something." "They want something from me." "They're being polite because we work together." The compliment is dismissed by disqualifying its source. The deflector does not have to receive the compliment because the compliment has been reclassified as not really a compliment — it has been recast as a manipulation, a courtesy, or a transaction.

"There's a thousand ways where we don't let the compliment in." -- Joe Hudson, You're Pushing Away What You Most Want

All three forms are versions of calling the giver a liar. Form 1 calls them a liar about the fact. Form 2 calls them a liar by accepting the words while privately disbelieving them. Form 3 calls them a liar about their motive. The verbal surface differs. The structural move is identical.

Form 3 deserves specific attention because it is the form most often missed in self-assessment. The deflector who has stopped denying the fact and stopped silently disbelieving may still be filtering compliments through the suspect-the-motive lens. The compliments do not land because they have been preemptively reclassified as not really compliments. The work to dissolve this form is the same as the others: notice the move, do not act on it, let the compliment land as if the motive were exactly what it appears to be.

## The Perspective-Flip Move (Imagine Giving Someone a Compliment They Reject)

A short instruction Joe deploys to make the cost of the deflection vivid from the inside: have the deflector imagine themselves as the giver of a compliment that gets deflected. Most people do not have to imagine very hard — they have been on the giving end recently. The imagination accesses the body's actual memory of what it feels like to give a compliment that bounces.

"Can you imagine you give somebody a compliment? As a matter of fact, I don't think you have to imagine. You give somebody a compliment and they're like, 'No.' Like, how much do you want to give them a compliment again? How much are you like, oh yeah, that's cool, let me do that every day where that person tells me I don't know what I'm talking about and I don't know them, somehow create some separation between me and them because I gave them a compliment. I'm going to go do that again tomorrow." -- Joe Hudson, You're Pushing Away What You Most Want

The move is the perspective-flip variant of the principle. Conceptually understanding that deflection costs the giver is not the same as feeling it. The flip puts the deflector inside the giver's body, where the cost is registered as the specific felt sense of not wanting to extend again. The body learns from the inside that deflection is not a neutral move. The cost has a felt signature, and the deflector has been producing that signature in others for years.

The follow-up insight Joe names in the same arc: "All the while that person is wanting my approval, but when then they get it, they reject it, they make me feel bad. And so that's what makes this so interesting, is that the thing that we want most, we want the approval, we want the gratitude, we want the appreciation, but then when we get it, we're often rejecting it. And so people don't give it to us."

The deflector has been generating the absence of compliments by their response to the compliments that have been arriving. The complaint "no one appreciates me" is then the downstream of the deflector's own behavior. The perspective-flip move is what lets the deflector see this loop from the inside rather than continuing to experience it as something done to them.
...
## The Boss-Stops-Complimenting Variant (How the Deflection Produces the Not-Seen Story)

A specific workplace form of the cost-to-the-giver makes the structural loop visible. The employee who deflects the boss's compliments produces the absence of future compliments, then reads the absence as evidence the boss doesn't see them, then works harder to be seen, then deflects the next round, and so on. The deflection is the engine of the not-being-seen story that runs the burnout.

"Your boss gives you a compliment, you don't let it in. What do you think of the chances that your boss wants to give you another compliment?" — Joe Hudson, Why Your Boss Never Sees You

"Maybe near to zero." — Client

"Yeah, especially after the 10th one or something, right? And then you can be like, see, he doesn't see me, I have to work for it. It's this crazy game you're playing." — Joe Hudson, Why Your Boss Never Sees You

The loop has the same structure as the cake metaphor (the giver who is met with mm-hmm stops bringing cake) but the workplace context makes the cost more severe. The boss who has stopped complimenting is not just a friend who has stopped baking. The boss who has stopped complimenting becomes the not-seeing boss whose absence of recognition produces, in the employee, harder producing in pursuit of the recognition that is no longer arriving — and the harder producing is what produces the burnout. The deflection is not just rude; it is the mechanism by which the employee is generating their own burnout through a self-perpetuating loop.

The structural diagnosis: the boss who used to give compliments and stopped is often not a withholding boss. The boss is responding to the somatic data that the compliments do not work. The employee who experiences the boss as withholding is experiencing the downstream of their own deflection. The leverage to change the dynamic is on the employee side, not the boss side. See [[you-cant-win-the-see-me-wont-be-seen-game]] for the full structural principle this variant illustrates.

The corrective for the employee in this loop is not "work harder to get the boss to see you." That is the same engine. The corrective is to open the receiving channel so the compliments that do arrive can land. Then the boss, encountering compliments that work, returns to offering them. The cycle inverts: receiving produces more recognition rather than deflection producing less.
...
- 2025-08-07_Why Your Boss Never Sees You (Even When They Try) - Follow-along Coaching Session (the boss-stops-complimenting variant; the explicit loop diagnosis "your boss gives you a compliment, you don't let it in — what do you think of the chances your boss wants to give you another compliment? — near to zero — yeah, especially after the 10th one"; the structural framing that the deflection produces its own evidence of not-being-seen, which produces harder producing, which produces burnout; the link from compliment-deflection to the unwinnable-game configuration that drives recurring workplace burnouts)
- 2025-11-18_You're Pushing Away What You Most Want (the explicit enumeration of three deflection forms: verbal denial of the fact, polite verbal acceptance with internal denial, and attributing motive to the giver; the framing that all three are forms of "calling them a liar" — the motive-attribution form is calling them a manipulator, the internal-denial form is calling them ignorant; the unique addition of motive-attribution as a third distinct form that the prior teaching had not enumerated; the imagined-perspective-shift instruction "Can you imagine you give somebody a compliment and they're like, no. Like, how much do you want to give them a compliment again?" as the perspective-flip move that lets the deflector feel from the inside what their deflection produces in the giver)
