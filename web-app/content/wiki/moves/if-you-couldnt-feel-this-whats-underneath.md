...
- **If the person gives a "right" answer** (a word that sounds like the answer Joe is fishing for, like "love"): reject it. See [[fuck-the-right-answer]]. The right answer is not the felt answer. The person is performing the destination rather than discovering the next step. The move is to refuse the performance and ask again.
...
At the bottom was the love. "In the heartbreak and that sadness, it's like, that's the love." See [[heartbreak-is-the-love-underneath-the-blockers]].
...
- When the [[i-feel-guilty-for-cutting-off-family]] or any concern centered on a blocker emotion is what the person presented with.
- When [[looking-for-whats-wrong]] is the read — the person is searching for a problem to work on rather than feeling what is here. The underneath-question redirects from searching to descending.
