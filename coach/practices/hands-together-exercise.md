...
A short somatic exercise to feel the difference between trying and undoing.

**Step 1.** Put your two hands together, palms touching, in front of your face.

**Step 2.** Try as hard as you can to pull your hands apart. While trying, keep them together. If your hands are now apart, you are not trying, you are doing. So stop, return to the position, and *try* without succeeding.

**Step 3.** Notice every muscle that engages in the trying. The forearms. The shoulders. The chest. The face. The whole system loads.

**Step 4.** Without thinking about it, feel the exact opposite of what you were just feeling. That release, that opposite, is what undoing feels like.

## The Quote

"If you put your two hands together and put it like, let's say, the palms of your hands in front of your face, and try as hard as you can to pull your hands apart. And if your hands are apart right now, you're not trying, you're doing. So forget the doing and just go to the trying. And try as hard as you can to pull your hands apart. And now, without thinking about it, feel the exact opposite thing that you feel when you're trying. That's what it means to undo. You're undoing." -- Joe Hudson, The Art of Accomplishment

## Purpose

The exercise demonstrates two things at once.

First, it shows that trying is a measurable somatic state distinct from action. You can be fully engaged in trying without producing any movement. The body is loaded, fuel is burning, nothing is happening.

Second, it shows that undoing is not another kind of trying. You cannot try to undo. The release happens by feeling the opposite of trying, not by adding effort in the other direction. This is the entry point to [[undoing-not-doing]] as a method.

## What the Opposite of Trying Reveals

The "feel the exact opposite" instruction in Step 4 does more than release tension. It opens access to a specific state that Joe names variously: receiving, allowing, listening, being a channel. Most people are unfamiliar with this state as an option. The exercise gives them a body anchor for it.
...
The relevance: most of the things people most want (peace, joy, pleasure, authenticity, resilience, the capacity to listen) live on the receiving side of the toolkit, not the trying side. The exercise is the door into the receiving side. See [[opposite-of-trying]] for the full concept this exercise illustrates somatically.

## What People Notice

The common report:

"As I did that, there's a sense of planning going on throughout my entire system, like imagining which muscles I would move and how to move my hands apart. And I can do all of that without actually moving at all. It feels like a good metaphor for beating myself up over a to-do list." -- Brett Kistler, The Art of Accomplishment

The recognition is often immediate: this is what I do all day. I try without doing. I load the system without producing movement. The exercise gives a name and a felt sense to that pattern.

## When to Use This

- When someone describes feeling exhausted from work that did not actually get done.
- When someone is grinding on a task without progress and needs a felt sense of why.
- When introducing [[undoing-not-doing]] as a method and wanting a somatic anchor.
...
For many, the immediate next question is: "Then what do I do instead?" The honest answer: there is nothing to do. You feel the opposite of the trying. That release is the move. The action arises from the released state, not from more loading.
