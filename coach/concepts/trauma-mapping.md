...
Trauma mapping is the process by which people manipulate, attract, and prove the reality of their original traumatic experience. A person whose early experience taught them a particular emotional truth (e.g., "love is criticism") will unconsciously organize their life to confirm that truth. They attract critical people, hear criticism where none exists, and behave in ways that provoke the very response they fear.

This applies to both acute trauma and attachment wounds. The mechanism is the same: the organism seeks homeostasis by returning to what it knows, even when what it knows is painful.

## In Practice

"If a person has been taught that love is criticism, they go around manipulating the world, attracting critical people, proving that love is criticism. They're hearing criticism when it doesn't actually happen." -- Joe Hudson, A Discussion with Dr. Bessel van der Kolk & Joe Hudson

The pattern operates at three levels:
- **Attraction:** Gravitating toward people and situations that replicate the original wound
- **Perception:** Interpreting neutral events through the lens of the original wound (hearing criticism that is not there)
- **Provocation:** Behaving in ways that elicit the feared response from others

## What Breaks the Pattern

The pattern dissolves when the emotion suppressed during the original trauma is fully felt and welcomed. See [[feeling-the-unfelt-emotion]]. The body no longer needs to recreate the situation because the unfinished emotional business is complete.
...
## Trauma Mapping as the Victim Direction of the Trauma Cycle

Trauma mapping is the victim-direction expression of the [[victim-or-abuser-cycle]]. The cycle has two outputs in adult life: the person either recreates the original wound as the receiver (the trauma-mapping mechanism described in this article) or develops the urge to do the wound to others (the abuser-direction). The two are mirror images of the same unprocessed material. See [[two-paths-of-trauma-response]] for the binary frame and the coaching implications for each path.

The mapping mechanism in this article describes the victim-direction in full detail. The abuser-direction operates by a parallel mechanism — the unprocessed rage and helplessness seek outlets in the form of urges to hurt — but produces different downstream effects. A specific person can predominate in one direction while showing some blending into the other; the endurer who would never harm anyone in their lives may still find themselves in one relational pocket where they recreate the original victimhood. See [[endurer-pattern]] for the configuration that often holds the abuser-direction urge in check.
...
The language of "attracting" or "recreating" can sound passive. A more accurate framing emphasizes the body's active construction of the conditions: engineering. The person who is most afraid of heartbreak engineers the conditions for heartbreak. The hyper-focuser engineers the disconnection. The high achiever engineers the burnout. The construction is unconscious but precise.

"You're engineering heartbreak that you then avoid. And then you get to feel heartbreak/shame for avoiding the thing that you created to feel that you'd not using the feel." -- Joe Hudson, Allowing Yourself to Change

The engineering frame is particularly useful when the passive frame has started to produce self-pity. Returning agency without returning blame is the work. See [[engineering-heartbreak-to-avoid-heartbreak]].
...
The perceptual face of the mechanism is supported by [[negative-bias-of-trauma-imprinting]]: the brain encodes the negative lesson and filters out the surrounding data that would have complicated it. The lesson dominates; the complicating evidence becomes invisible.
...
- When someone reports "always ending up with the same kind of person"
- When someone cannot understand why they keep creating situations they claim to hate
...
- 2026-04-28_I've Coached 1000s in Pain. 'I'm Sorry' Isn't What They Need (Joe explicitly framing trauma-mapping as the victim-direction expression of the larger trauma cycle — "I was abused and I either become the victim or I become the abuser ... you keep on finding relationships that are abusive, you keep on finding places where you're going to get physically abused"; the binary frame between victim-recreation and the abuser-direction urge as the two outputs of unprocessed abuse)
