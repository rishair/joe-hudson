...
Each emotion, allowed to flow without resistance, carries specific information. The information is the emotion's purpose. When the emotion is suppressed, the information is lost. When the emotion is felt, the information becomes available. The work is not to manage emotions but to read what they are telling you.

This is the wisdom-side of [[emotions-as-road-signs]]. Emotions point at something; each one points at something specific.

## Anger: Deep Care, Boundaries, What to Be Determined For

Anger is one of the deepest forms of care. It shows up when something you care about has been violated, when a boundary has been crossed, when you have not been taking care of yourself, when something matters enough that you will be determined about it.

"The anger is a deep form of care. It shows us when we have a boundary that has been crossed. It shows us when we're not taking care of ourselves. It shows us what we want to be determined for in our lives because we care so deeply about it." -- Joe Hudson, Stages of Emotional Development
...
Fear points at value at risk. Every fear is fear of losing something, and tracing the fear reveals what is loved. See [[fear-as-signal-of-care]] for the full treatment.

A common specific form: fear signals that a need is not being met and is not being asked for. The person is taking care of others before themselves, not putting on their own oxygen mask first. The fear is the system escalating because the need has been ignored long enough.
...
The positive emotions carry their own information. Joy signals that the channel is open. Bliss signals depth. Peace signals integration. They are the rewards of the flowing system, and they themselves point at what is alive and connected.

Joy as the matriarch of the family of emotions shows up when all the others have been allowed in. Its arrival is evidence of welcome. See [[joy-as-matriarch]].

## The General Principle

Each emotion is doing exactly what it is supposed to do. Anger is supposed to be there when a boundary is crossed. Fear is supposed to be there when something is at risk. Sadness is supposed to be there when something is changing. Joy is supposed to be there when the system is flowing.

The problem is not the emotion. The problem is the resistance to the emotion, which kinks the flow and produces the difficult versions people associate with the emotion itself.
...
When a person reports they have "figured out what their emotion means" but the same emotion keeps recurring, they have most likely interpreted without feeling. The interpretation is the management. The feeling has not happened. See [[repression-vs-management]].

When a person reports a chronic difficult emotion, the first question is not what it means but whether they are letting it move. The wisdom is downstream of the flow.

## Tone

Practical and respectful. Each emotion is presented as a colleague rather than as a problem. The work is to listen to what each one knows.

## Upstream (What Leads Here)

- When someone is trying to figure out why they keep feeling a certain emotion.
- When someone treats their emotions as obstacles rather than information.
- When the coaching path needs to move from managing to reading.
- When a person is at Stage 5 of [[stages-of-emotional-development]] and starting to notice the messages each emotion carries.

## Downstream (Where This Leads)

- Toward [[emotions-as-road-signs]]: the broader frame that emotions point rather than push.
- Toward [[fear-as-signal-of-care]]: the specific treatment of fear's wisdom.
- Toward [[feeling-the-unfelt-emotion]]: the practice that makes the wisdom available.
- Toward [[the-want]]: many emotional messages point at unmet wants or needs.
