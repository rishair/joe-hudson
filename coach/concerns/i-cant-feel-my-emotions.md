...
The defining feature is the explicit report that the question of how they are feeling does not produce an answer in any normal sense. The person is not refusing to share. They genuinely do not have access.

- "When people ask me how I feel, the phrase 'how do you feel' does not even vaguely compute."
- "I really struggle to feel my own emotions."
- "I don't know how I'm feeling."
- "I can't tell what emotion I'm having."
...
- The person is articulate, fast-thinking, head-dominant. Often a successful professional, content creator, or operator.
- They describe their work as a stream of decisions, content, output -- with no felt-sense markers attached.
- When asked about a feeling, they pause, look up, and produce an intellectual answer that describes the situation rather than the felt experience.
- They are observed to be having an emotional response (water in the eyes, voice change, body movement) and report no internal awareness of it.
- They may distinguish between the emotions they have access to (excitement, satisfaction, mild frustration) and those they don't (love, sorrow, deep grief, deep joy, anger).
- They may report that other people can read their emotions before they themselves can.
- They have already noticed the gap. They know feeling is the thing they don't have access to and they want it.

A common version of this concern in a coaching session: the person comes in to work on something else, and somewhere in the first ten minutes they add, "and one other thing I'd love to talk about -- I struggle to feel my own emotions." The emotional inaccessibility is named as a separate item but is almost always the substrate of every other topic they brought.

## What Joe Hears

The body is doing all the things bodies do when emotions arise. The wires from body to conscious awareness have been cut, dimmed, or never developed. The cut is usually a survival adaptation from a childhood in which feeling was unsafe, unwelcome, or unavailable to model.

The human system is smart. Joe describes it through the abused-child-and-the-quarter experiment: a child who has been physically abused, given a quarter in one hand and a key in another without seeing, cannot tell as an adult which hand holds which. The system shuts off what is too painful to access. The shutdown survives the original conditions.

The mechanism is not just "I was told not to feel." It is more often: "the people around me could not see emotions, so I was never trained to see them in myself." Joe's definition of emotional abuse for this purpose: somebody held you responsible for their emotional state, or somebody told you the emotions you were having were not okay to have. Both produce the same downstream pattern: the system stops generating recognizable feeling-signals because the signals were not useful when they were arriving.

The body is still doing emotion. The chin lifts, the jaw tightens, the breath catches, the eyes water, the voice changes register. The person can sometimes see the body doing these things and still not feel anything. The disconnect is not at the body level. It is at the awareness level.

The person who cannot feel is usually still highly intelligent about emotion. They can describe the theory of feelings, identify them in others, write about them. The gap is specifically the felt-sense access in their own system. Often, the first emotion they will recognize is not the underlying one -- it is the somatic experience of trying to feel and not getting there. That experience is itself the doorway. See [[manufacturing-the-feeling]].

## What Joe Looks For (Reads)

Two people can present this concern and Joe goes different directions based on what he reads.

- If the body shows a clear repression signature (chin lifted, jaw clamped, fast head-driven speech): Joe names the somatic marker. He often introduces the teaching that one of the main ways humans stop emotion is raising the chin (the narcissism position) and clamping the jaw. He invites the person to drop the chin and notice what changes. See [[chin-up-as-emotion-block]].

- If the person describes trying to feel something and not getting there: Joe redirects the attention from the absent feeling to the present sensation of trying-and-not-getting-there. The trying is itself a felt experience. See [[manufacturing-the-feeling]] and [[trying-prevents-the-feeling]].

- If the person reports an unexpected body sign (tears, throat tightness, breath shift) without knowing what it is: Joe names it for them. "That's gratitude." "That's grief." "That's joy with some excitement in it." He provides the felt-sense vocabulary the person never built. The recognition is often what installs the wire from body to awareness.

- If the person reports that they have access to positive emotions but not negative ones (or vice versa): Joe will set up the live experiment of cycling between a memory of one and a memory of the other and holding both simultaneously. See the dialogue example below. The contrast surfaces the somatic signature of each.

- If the person describes themselves as 'head-dominant' or 'intellectually based': Joe meets them in the intellect first, then drops into the body. The head-dominant person needs the intellectual frame before they can trust the somatic exploration. See [[take-access-points-wherever-you-can-get-them]].
...
3. Run the live contrast experiment when the person reports differential access. Pick an emotion they can feel and one they cannot. Have them recall a memory that brings up each. Have them cycle: feel one, then the other, then back, then both at once. The contrast teaches the body what to look for. The contrast also reveals which body region holds each emotion. See [[toggle-between-opposite-emotions-then-hold-both]].

4. Name the felt sense as it arrives. When the body produces an unrecognized response (water in eyes, breath change, smile), name what emotion it is. Do this in a tone of "did you know that's what that is?" The naming installs the language the person never built.

5. Trace the inaccessible emotion to its first instance. If the person cannot access sadness or anger or grief, look at the childhood configuration. Often there is a specific story: the unrequited love that was rationalized away, the loss that was buried under achievement, the parent who could not see the feelings, the family that valued the mind over the body. See [[trace-emotion-to-its-first-felt]].
...
- **Joe:** "Come up with a memory you can share or not share, doesn't matter, that immediately brings up the feeling of love in your system. Maybe it's a dog or a brother, younger sibling, cousin."
- **Person:** [holds a memory]
- **Joe:** "That's enough. Now think of a memory that's sorrow, loss of something."
- **Person:** [notices reluctance to go there] "I have this weird sensation of like, oh, you know, I don't want to go there. But that's weird. I do want to go there."
- **Joe:** "Yes. Somebody taught you it wasn't safe at some point, or the world in general did. There's an automatic reaction to it."
- **Person:** [holds the memory of sorrow]
- **Joe:** "Now back to love. And back to sorrow. One more time, back to love and back to sorrow. And now hold both of them at the same time."

The person reports a squeezy sensation in the area below the left ribcage for sorrow, and a sense of expansion outward for love. The expansion was not previously feelable. The contrast made it accessible.

*(Source: Ali Abdaal coaching session)*

The mechanism: the body's signature for each emotion becomes detectable only when there is a comparison. The contrast acts as a calibration device. After this exercise the person has felt the somatic signature of both emotions and can begin to recognize them in real-time.

## What This Concern Is Not

- It is not necessarily depression or dissociation in the clinical sense. It is often a non-pathological adaptation in a head-dominant nervous system.
- It is not a sign of being broken. Many highly functional people operate without felt-sense access for decades. The gap shows up when they try to do something that requires it -- intimate relationships, parenting, deeper coaching, leadership at scale.
- It is not solved by talking about emotions. It is solved by feeling them. Talking about the gap is part of the route, but the route is not complete until somatic access arrives.
- It is not solved by going to therapy and naming events. The naming may help. The body learning to feel is a different kind of work -- it requires repeated invitations into the body, not repeated cognitive frames.

## Related Concerns

- [[im-not-an-anxious-person]]: the related identity for the head-dominant person who has cut off felt access to specific emotions, especially fear.
- [[i-keep-doing-things-i-dont-want-to-do]]: often co-occurs because the want signal is felt and the person cannot feel it.
