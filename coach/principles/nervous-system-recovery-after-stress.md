...
related: ["i-keep-crashing-and-burning", "enjoyment-as-path", "self-realization", "pleasure-capacity", "should-as-threat", "i-should-be-doing-this", "ceo-pajama-house-study", "will-chesney-seal-collapse-and-return", "sustained-fear-requires-post-hoc-processing", "depression-four-levels", "im-depressed", "burnout-cycle", "im-burned-out", "rest-is-an-accomplishment", "post-rest-second-wind-trap", "stress-burnout-depression-progression", "optimize-for-downtime-not-productivity", "quality-of-downtime-matters"]
sources: ["2021-07-02_Allowing Yourself to Change (Joe Coaches Brett)", "2022-05-13_Will Chesney — Reintegrating as a Combat Veteran, Surviving a Traumatic Brain In", "2022-10-26_The Self-Discovery Of A Navy SEAL", "2023-06-23_Exploring Depression in the Head, Heart, and Gut", "2023-09-01_The Burnout Cycle", "2025-07-29_Why You're Exhausted (Even After Resting)"]
---
...
When the nervous system has been operating under stress for an extended period, the body will produce a physical depression in which motivation drops and energy is low. This is not a failure of will. It is a recovery mechanism. The deer that has been chased by a tiger for twenty days needs to lie down for a while afterwards. The animal is not broken. The animal is recovering.

The principle: physical depression following sustained stress is normal and adaptive. The error is to interpret it as a problem to be solved with more activity.
...
In the 2025 retelling Joe makes the progression explicit: stress → burnout → depression as a "highly linked" sequence. The progression is the motivation for catching the cascade early; pushing through stress is what produces the burnout that produces the depression. See [[stress-burnout-depression-progression]] for the full structural treatment of this arc and why catching it at the stress phase is dramatically cheaper than catching it at the depression phase.

"You're running off adrenaline, you don't have enough adrenaline, so you use coffee that amps up your adrenaline, and then eventually your adrenals just fail on you and then you get depressed, and so then you get antidepressants." -- Joe Hudson, Why You're Exhausted (Even After Resting)
...
A specific recursive loop forms when a person does not understand that the depression is recovery:

1. The body shuts down to recover from the stress.
2. The person interprets the shut-down as evidence of being broken / lazy / wrong.
3. The interpretation produces shoulds: "I should be doing something."
4. The shoulds add stress to the system that was already trying to recover.
5. The recovery period extends.
6. The extension is interpreted as more evidence of brokenness.

The loop is exhausting and self-reinforcing. Naming the principle (this is what bodies do after prolonged stress) often breaks the loop directly. The person stops adding shoulds and the body completes the recovery.

"There's this like sitting down and doing nothing but being stressed about it. Oh gosh, requires that release. And then the depression, it's like, see, I'm doing nothing, I'm — that's why I'm depressed. I got to do something, and then it loops back on itself." -- Brett Kistler, summarizing the loop in Allowing Yourself to Change. Joe's response: "That's exactly how it works."

## What Recovery Looks Like

Recovery from sustained stress can look like:

- A drop in motivation that has no clear external cause.
- A pull toward stillness, sleep, doing very little.
- A loss of interest in the activities that occupied the stress period.
- A felt sense of being "depressed" that may not match clinical depression but resembles it.
- A natural narrowing of life to basics: eating, sleeping, being.

These are not symptoms to be treated. They are the form of the recovery. The system is doing what it needs to do.

## When the Recovery Becomes Depression

The recovery becomes pathological when the loop above sets in: shoulds get added on top of the body's need to rest, the rest cannot complete, and the shut-down state becomes self-perpetuating. At that point what was adaptive becomes stuck.

The intervention is not more effort. It is releasing the shoulds that are blocking the recovery. The body knows how to come back online. It needs permission, not pressure.

## When Someone Experiences This

- After a sustained period of work, caregiving, performance, or stress.
- After completing a major project (selling a company, finishing a book, ending a relationship).
- During the integration phase after a transformative experience. See [[integration]].
- When the rabbit-hole cycle has crashed. See [[i-keep-crashing-and-burning]].
- When the person reports unexplained low motivation that they are trying to fight through.

## Upstream (What Leads Here)

- When someone is forcing themselves to "get back on track" after a prolonged stress period.
- When the language of "I should be doing more" appears alongside reports of low energy.
- When [[i-keep-crashing-and-burning]] has been worked at and the recovery phase is the actual current question.
- When [[i-should-be-doing-this]] is being applied to "I should not be in a bathrobe."

## Downstream (Where This Leads)

- Toward permission to rest without making the rest into a project.
...
The intervention is light. Name the principle. Stop interpreting the recovery as a problem. Let the body do what it is doing.

"There is a nervous system piece to this, which is if you're operating under stress for an extended period of time, your body will go into a physical depression and not be motivated. So like, that is — that's natural, right? Like, if a deer has — gets chased by a tiger for 20 days straight, it's gonna definitely need to like sit down and do nothing for a bit." -- Joe Hudson, Allowing Yourself to Change

## Tone

Matter-of-fact. Almost biological. This is what bodies do. There is no moral content. The recovery is not a sign of weakness or strength. It is a sign of an animal that has been under sustained stress.
...
- 2025-07-29_Why You're Exhausted (Even After Resting) (the explicit naming of the stress → burnout → depression progression as a "highly linked" sequence; the retelling of the acupuncture story with the adrenaline-coffee-depression-antidepressants progression and the early-Prozac historical detail; the explicit motivation argument that without seeing the progression you don't have motivation to address the stress early)
