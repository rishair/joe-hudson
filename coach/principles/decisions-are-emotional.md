...
All decisions are made emotionally. Without emotional centers in the brain, decision-making collapses. A person would take thirty minutes to choose a pen color and four hours to choose where to eat lunch. Logic is a tool that serves emotional goals, not a competing system.

This principle is documented in neuroscience (see Descartes' Error by Antonio Damasio). It is not a theory. It is an observed fact about how the brain functions.

## In Practice

People buy Nike shoes at $200 not because the specifications justify the price, but because of an emotional experience. Software purchases, hiring decisions, loyalty to a boss, willingness to follow a leader: all emotionally driven. Logic helps identify the most likely path to the desired emotional outcome ("I don't want to get yelled at, so I'll use logic to figure out how to avoid that"), but the decision itself is emotional.

"We make decisions emotionally. So do people pay $200 for Nike shoes because they think that it's $200 worth of shoe? No, they're making an emotional decision." -- Joe Hudson, Introduction to VIEW

This is why [[view]] works in sales, teams, and relationships. VIEW acknowledges, owns, and addresses the emotional dimension of conversation. Communication that ignores the emotional layer misses where decisions actually happen.
...
## How Unfelt Emotion Disrupts Decision-Making

When an emotion is being avoided, decisions cannot be clear. The data the intellect is working with is contaminated by the avoidance. The decision is no longer "what do I actually want here" but "what action lets me avoid the feeling I do not want to feel."

Three observable signals indicate that unfelt emotion is corrupting decision-making: recursive thought loops, sustained indecision despite sufficient information, and judgment of another person. See [[three-signals-of-unfelt-emotion]]. A fourth signal, [[binary-thinking-signals-fear]], shows up when the mind narrows possibilities to two options to avoid sitting with the wider field.

"It's when your emotions are blocked or when you're trying to deeply avoid an emotion, then your decision-making can't be clear. It's just as simple as that." -- Joe Hudson, Feel over Figure

The intellect is not the problem. It is excellent at solving puzzles once the postulates are clear. The postulates are emotional. Without emotional clarity, the intellect is solving the wrong puzzle. See [[feel-over-figure]].

## Why the Same Facts Produce Opposite Conclusions

Gödel showed that all logical systems are either incomplete or rest on a postulate. In human reasoning, the postulates are emotions. Two intelligent people can reason rigorously to opposite conclusions because they are starting from different emotional foundations.
...
## The Beginner-Facing Diagnostic Question

The public-facing video version of the same teaching compresses the principle into a series of recognizable everyday decisions that beginners can verify in their own history:

"How many times have you made a decision because you wanted to feel good or because you wanted to not feel like a loser or because you wanted to feel loved or you didn't wanna feel rejected or you wanted to feel like a success or you didn't wanna feel like a failure?" -- Joe Hudson, 4 Ways To Feel Your Emotions

The question form is more usable as an entry diagnostic than the Damasio-and-Gödel framing. A person who has not yet accepted that decisions are emotional can usually still admit, when prompted with these specific feeling-states, that yes, that is exactly what was driving the choice. The list is short on purpose: success, failure, rejection, love, looking-like-a-loser. These cover most of the everyday decisions people report having made for unstated reasons. Once the person sees the feeling that was actually driving the decision, the principle is no longer abstract.

This formulation also pairs naturally with [[four-tactical-ways-to-feel-your-emotions]]: if the unconscious emotional driver of decisions is the problem, the four tactical ways are the practical answer. Recognize the feeling, breathe through the muscle holding, feel it in the body, express what wants to move. The same emotion that was driving the decision unconsciously becomes feelable, which removes its capacity to drive unconsciously.
...
## The Operational Sequence: Intellect, Then Emotion, Then Body Picks the One

A practical version of this principle as a sequence: do the intellectual work fully, then drop into the felt material, then let the body indicate the one option that feels right. This is the inverse of "stop thinking and just feel" — it uses the intellect for what the intellect is good at, then hands the decision to the substrate that decisions are actually made on.

"Let your mind do all the processing. Look at the spreadsheets, look at the pros and cons, do the intellectual debate. It's fantastic. And then take a moment and like really feel like what feels like the right thing to do, and give credence to the frustration or the fear or the whatever... There's only one thing that's going to feel right when you do it. There's only one." -- Joe Hudson, How Saying "No" Sets You Free (Coaching Reaction Video)

The sequence works because:

1. **The intellectual work expands the option set.** If a person tries to feel into a decision without first letting the mind see what is on offer, the felt-options will be limited to whatever the defended position permits. The mind's job is to surface what is actually available, including the options the defended position would prefer to hide.

2. **The felt work picks among the available options.** The mind cannot tell you which option will produce the feeling-state you actually want. The body can. The body's pick is not arbitrary; it is the integrated response of the whole organism to the full option set.

3. **Difficult emotions are signal, not noise.** Frustration and fear in particular are usually pointing at real information. Frustration in business often signals "we're not being determined enough" or "we're not pushing hard enough." Fear often signals "there's a risk we're not accounting for." The instruction is to give credence to these emotions, not to override them.

The operational test of the sequence: after the mind has done its work, the body indicates the path that will feel right when actually walked. The "only one" framing matters — when truly contacted, the body does not return a tie. The tie was a product of incomplete contact. Slowing down enough to actually feel produces a single answer, not a continued debate.

This is also the practical answer to the "problem of is and isn't" — the paralysis a person hits when they have learned to hold multiple perspectives as partially true. The intellectual stance produces "well, this is true and that's also true." The body produces the next move. See [[every-no-contains-a-better-answer]] for the welcoming-all-perspectives work that this body-picks-the-one move completes.
...
## The One-Line Compression: Avoidance Is the One Thing Messing Up Decision-Making

The shortest form of the entire principle, delivered as a flat thesis when the audience needs the compressed teaching rather than the long version:

"There is one thing that's messing up your decision-making and it's avoidance. Period. End of discussion." -- Joe Hudson, Every Decision You Struggle With Has One Thing in Common

The compression matters because it removes all the secondary distinctions and goes straight to the structural claim: every decision that feels hard is a decision in which something is being avoided. The avoidance is the only variable. Everything else (the option set, the analytics, the stakes, the advice received) is downstream of whether avoidance is present.

The one-thing framing also closes a common off-ramp: the listener cannot say "well, decisions are complicated, there are many factors." The teaching insists that there is exactly one factor. The complications people add are the avoidance dressed up. Strip the avoidance and the decision becomes a choice.

## The Homeless Thought Experiment (Severing Outcome From Feeling)

The cleanest beginner-facing way to demonstrate that the avoided thing in a hard decision is always an emotion rather than an external outcome: take an outcome the person would obviously avoid and ask what would happen if the predicted feeling were severed from it.

"Nobody would say, I choose to be homeless. But if you knew that being homeless would make you happier than you've ever been, more content than you've ever been, more satisfied than you've ever been, you would at least be a lot less scared to be homeless, if not just completely okay with being homeless. So what we're trying to do is we're trying to avoid an emotional outcome." -- Joe Hudson, Every Decision You Struggle With Has One Thing in Common

The thought experiment works because the resistance to "being homeless" survives no examination once the predicted feeling has been guaranteed in the other direction. What the person was avoiding was never homelessness. It was the predicted feeling of failure, shame, helplessness, or rejection that homelessness was a proxy for. The outcome was the placeholder. The feeling was the substance.

This is the same mechanism as the billion-dollars-but-miserable thought experiment in the other direction. The billion-dollars-but-miserable example shows that a wanted outcome ceases to be wanted when the expected feeling is removed. The happy-homeless example shows that an avoided outcome ceases to be avoided when the feared feeling is removed. Both demonstrate that the outcome was never the actual deciding criterion. The feeling was.

The two thought experiments pair together as a complete demonstration. Use the billion-dollars version when the person is pursuing a goal they think they want and need to see what they are actually pursuing. Use the happy-homeless version when the person is recoiling from an option they think they cannot consider and need to see what they are actually recoiling from. In both cases, naming the predicted feeling that was hiding behind the outcome makes the actual decision visible.

## Doom-Scrolling and Drug Addiction Are the Same Move

The principle scales down to the smallest automatic choices. The choice to scroll, the choice to use, the choice to procrastinate — each is the same structure as a major life decision: an attempt to avoid (or produce) a feeling.
...
The implication: the difference between deciding which job to take and deciding whether to pick up the phone for one more scroll is only the scale of the decision. The mechanism is identical. Treat any apparently-trivial automatic behavior the same way as an apparently-major life decision. The avoided feeling is the work in both cases. The action is the proxy. See [[embracing-changes-unconscious-decisions]] for the full treatment of how this works at the daily-automaticity scale, and [[bad-habits-are-the-avoidance-of-essential-self]] for the cascade from essence-avoidance to addictive behavior.

The other direction matters too: the principle that decisions are clear when the person is willing to feel all emotions extends down to these small choices. A person who can feel the boredom or the loneliness or the avoidance-of-creative-work that the scroll is preventing does not need to scroll. The scroll choice dissolves the same way the major decision does — by the avoided emotion losing its capacity to drive.

## Life Is the Series of Choices and Decisions

A frame for why this principle matters more than any other single piece of methodology. The substance of a life is the sequence of choices and decisions made within it. Improve the capacity to choose well, and everything else improves automatically, because everything else is made of choices.

"When you think about all your life is, is a series of choices and decisions from the moment that you're born to the moment you die. You make choices, you have decisions, and off you go. This is the life that you get. So when you improve that skill, everything improves. The relationships with parents improve, your job improves, your life improves, because it is the quintessential thing that runs our life, is the choices that we make, is the decisions that we make." -- Joe Hudson, Every Decision You Struggle With Has One Thing in Common

The frame elevates the work from "decision-making is a useful skill" to "decision-making is the substrate of the life." The leverage of getting clearer about how decisions are made is total: every domain (relationships, work, parenting, health, money) is downstream of the same mechanism. The reason transformation work appears to change everything at once is that it operates on this single underlying substrate.

The implication for prioritization: a person trying to decide what to work on first in their development should default to the work that changes how decisions are made. Almost any other improvement is downstream of this one. See [[embracing-changes-unconscious-decisions]] for the corollary about how the small automatic choices change as a byproduct.
...
"We have this, um, we have a course called the Decisions Course, and one of the things that we teach in that is that big decisions are usually just avoided emotions. We make decisions in the emotional part of our brain. If I took the emotional part of your brain out, you would take 4 hours to decide where to have lunch, but your IQ would be the same, neurologically speaking. So what's the emotion that you're trying to avoid in both of these two decisions?" -- Joe Hudson, How Do I Not Burn Out Again?

The diagnostic move asks the question on each branch of the fork. What emotion is being avoided in option A? What emotion is being avoided in option B? When the same emotion shows up on both sides, the fork dissolves. The person is not choosing between two paths. The person is trying to find a way to act that does not require them to feel the avoided emotion. That way does not exist; the emotion is going to show up regardless. The actual question is not which path to take but how to do anything without running from that feeling.

In the live session this surfaced in: the person presenting was choosing between starting a career again and starting a family, framing them as opposite paths. Joe asked the emotion-avoided question on each side. Both sides produced the same answer in different costumes: I don't want to experience burnout again, and I don't want to feel like I'm missing out on something. Both fears were the same fear of "a long time not doing something." See [[whats-the-emotion-youre-trying-to-avoid]] for the question article. See [[treating-it-as-a-decision-when-its-an-emotion]] for the read that triggers the question.

The IQ-stays-same / 4-hours-to-decide-lunch formulation is doing two jobs at once. First, it grounds the principle in neuroscience for a person who would otherwise dismiss "decisions are emotional" as soft. Second, it dignifies the difficulty: the inability to decide is not a failure of intelligence. Your intelligence is fine. Your decision-making is being routed through the wrong substrate. That reframe lets the person stop trying harder mentally and start asking the body what is actually being avoided.
...
- When a sales or leadership approach relies on data without attending to how people feel.

## Downstream (Where This Leads)

- Understanding this principle makes [[empathy]] practical rather than soft. Attending to emotions is attending to where decisions are made.
- Strengthens the case for [[view]] in business contexts where emotion is dismissed as irrelevant.
...
- 2024-05-27_How Do I Not Burn Out Again？ (the "big decisions are usually just avoided emotions" formulation; the IQ-stays-same / 4-hours-to-decide-lunch version of the neurological argument; live use as a diagnostic to dissolve a career-vs-family fork by surfacing the same avoided emotion on both branches)
...
- 2025-12-03_Every decision you struggle with has one thing in common (the one-line compression "there is one thing that's messing up your decision-making and it's avoidance — period, end of discussion" as the shortest form of the principle; the happy-homeless thought experiment as the inverse of the billion-dollars-but-miserable experiment, demonstrating that an avoided outcome stops being avoided when the feared feeling is severed from it; the doom-scrolling and drug addiction examples scaling the principle to small automatic behaviors; the "life is a series of choices and decisions" frame for why improving decision-making improves everything because everything is downstream of choices)
