...
Feeling helplessness does not make you more helpless. Feeling helplessness makes you more capable. The avoidance of the feeling of helplessness is what produces disempowerment. Moving through the helplessness is what produces empowerment.

"Feeling helpless doesn't make you more helpless. Feeling helpless makes you more capable. And it's so counterintuitive, but if you do it, you know it." -- Joe Hudson, Empower over Power

## The Mechanism

Most decisions are made to avoid an emotional state. Helplessness is one of the most-avoided states. The strategies for avoiding it (the [[fear-triangle]] roles, the pursuit of power over others) all begin where the willingness to feel helplessness ends.
...
The helplessness is the blame and shame felt all the way through. When you stop telling yourself the story of who is doing this to you (blame) or what is wrong with you (shame), what remains is the raw feeling of being unable to change the situation. That feeling is the helplessness.

"It's that helplessness is the feeling of that blame and shame felt all the way through that we don't want to feel." -- Joe Hudson, Empower over Power

The fear underneath the [[fear-triangle]] is the fear of feeling that helplessness. The triangle exists to keep the helplessness out of awareness.

## Why It Works

This is an instance of the broader pattern [[fear-is-about-feeling]]: fear of an outcome is never about the event itself, it is about what will have to be felt if the event happens. Once the feeling has been felt, the fear loses its grip.

Helplessness is the substrate emotion under many other fears. Fear of losing a job, a partner, a reputation, a future is usually fear of the helplessness that would follow. Feel the helplessness in advance and the constraint dissolves.

## In Practice

When someone is gripping control, the coaching path is not to give them more strategies for control. It is to invite them into the helplessness they are working so hard to avoid.

When someone is in the [[fear-triangle]] (victim, savior, bully), the coaching path is not to choose a better role. It is to feel the helplessness underneath any of them.

When someone has had a breakthrough and now grips it ("how do I keep it?"), the helplessness about losing it is what needs to be felt. See [[quit-hope-lose-cycle]].

The mistake is to try to think your way to empowerment, or to perform empowerment as a posture. Empowerment arrives on the other side of felt helplessness, not as a replacement for it.
...
Almost every high-powered CEO Joe has worked with has two recurring features: a deep sense of being alone and a chronic reliance on self-reliance. Both are built on top of a buried helplessness that was unbearable to feel at the time it formed.
...
## The Specific Substrate Under Self-Reliance: Disappointment Plus Helplessness

The CEO pattern above identifies helplessness as the buried emotion that built the self-reliance. A finer specification: what the self-reliant person was prevented from feeling at the time of installation is a particular compound of disappointment and helplessness. The original conditions produced an arrangement in which the person was supposed to be attuned to and was not. The cleaner first response would be disappointment about the failure of attunement, followed by the helplessness of being unable to make the attunement happen. Both are blocked. The self-reliance configuration installs to ensure that this compound never has to be felt again.

"There's a feeling that arises in you that's partially disappointment, but also helplessness. And you just are not going to allow yourself to feel that. And so, no, I'm not going to feel that. I will be determined as hell. I will focus. I will do whatever. I will push and pull and scream and scratch to get it so that I don't ever have to feel that level of helplessness again." -- Joe Hudson, Self-Reliance Is A Trap

The will / drive / determination is the felt activation that arrives when the helplessness is being kept out. The high-functioning leader who is described as a force of nature is often someone in whom this configuration is operating at full strength. The same drive that built the career is the same drive that is keeping the helplessness out of awareness. The work, per this principle, is to let the helplessness back in. The drive does not disappear when that happens; the drive's anxious overtone changes. The capacity is preserved; the configuration that required the capacity to be always on is what dissolves.

The further specification: the self-reliant person also typically cannot complete the [[mourn-the-breakup-fully|mourning process]] for their losses. The mourning requires feeling the helplessness; the configuration is organized around not feeling it; so the losses accumulate without being grieved. Brett names this directly during the conversation: "It's like I wanted something, I got disappointed, I let myself feel the heartbreak of it and be seen in that. And then I can move on to what's next." The middle step — feeling the heartbreak and being seen in it — is what the self-reliant configuration blocks. Without that step, the person reports moving on but does not actually integrate the loss, which leaves them more vulnerable to the next instance of the same dynamic. The configuration produces the appearance of resilience while preventing the actual processing that resilience requires.

This is why self-reliant people are often described as the hardest to do this kind of healing work with — the very configuration that the work needs to address is the configuration that prevents the work from happening. The work requires mourning; the configuration prevents mourning; so the door stays closed. The opening is usually external: a friend's well-aimed sentence (see [[you-make-that-impossible]]), a crisis large enough to overwhelm the configuration (Stacy's breast cancer diagnosis), or a slow accumulation of small openings that eventually let one loss be felt cleanly enough to demonstrate that the feeling does not destroy the person.
...
"If we're most scared of feeling helpless, we will invite helplessness unconsciously into our life so that we have that opportunity to feel it." -- Joe Hudson, Feel over Figure

The loop completes only when the helplessness is felt and welcomed. Then the body stops generating the conditions.

## Upstream (What Leads Here)

- When someone is stuck in the [[fear-triangle]] and trying to find a better role
- When someone says "I have to keep control of this or everything falls apart"
...
- 2025-01-31_Self-Reliance Is A Trap (the specific disappointment+helplessness compound under self-reliance configurations; the will/drive/determination as the felt activation that keeps helplessness out; the structural blocking of the mourning process by the self-reliance configuration; the implication that healing the configuration requires the very feeling-process the configuration is organized to prevent)
