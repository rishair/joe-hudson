...
A common misunderstanding of the [[embrace-intensity]] principle. People hear that intensity is the path to transformation and conclude that they need to seek out or manufacture intensity. They start setting up difficult conversations, taking risks, pushing themselves into hard experiences, all in the name of growth.

This is not the principle. The principle assumes that intensity is already present in any given moment. The work is to embrace what is already there, not to generate more.

"Embracing intensity assumes that there is never a moment when there isn't some intensity to embrace, that there's really nothing to create in the situation." -- Joe Hudson, Embracing Intensity
...
Joe makes a careful exception: creating intensity is sometimes a useful tool, particularly in structured environments like courses or workshops. The container can be set up to surface material that would not surface in daily life. This is legitimate use, when the participants have consented and the surrounding work is in place.

"I like creating intensity every once in a while. Don't get me wrong. I think it's a really useful tool, but it's not a principle to live life by." -- Joe Hudson, Embracing Intensity

The distinction: tool vs. principle. Creating intensity is occasionally useful as a tool. Embracing intensity is reliably useful as a way of living.

## The Test

When intensity arises, ask: did this happen on its own, or did I arrange for it to happen? If you arranged it, examine the motivation. If the motivation was to have something to embrace, you are creating intensity. The intensity that was already present in the moment was being missed; the manufactured intensity is a substitute.

If you did not arrange it -- if the difficult conversation surfaced because something needed to be said, if the fear arose because something real is at stake, if the sadness emerged because something is genuinely sad -- then there is intensity to embrace. The embrace is the work.

## Tone

Joe delivers this distinction quickly and almost in passing -- "that wouldn't be embracing intensity. That'd be creating intensity. Big distinction." The tone is matter-of-fact, not a stern correction. The error is common and easy to make. The distinction takes about a sentence to draw.

## Upstream (What Leads Here)

- When someone reports that they have been seeking out intense experiences in the name of growth.
- When a person is engineering crises or conflicts and calling it "embracing intensity."
- When [[embrace-intensity]] has been introduced and the person is in danger of misapplying it.
- When the felt sense in the system is excitement-of-doing rather than welcoming-of-what-is.

## Downstream (Where This Leads)

- Toward [[embrace-intensity]]: the corrected understanding of the principle.
- Toward [[embrace-vs-brace]]: the felt-sense diagnostic that catches manufactured intensity (the body is still bracing).
- Toward [[manufacturing-the-feeling]]: the adjacent read for when someone is producing the emotion rather than allowing it.
